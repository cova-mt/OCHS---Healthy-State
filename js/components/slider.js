class ClSlider {
    // opts = {targetSize | showMarkers \ noCycle}
    constructor(id, cTime, opts) {
        ...
        this.cTime = cTime || null; // if cTime is null, no cycling
        this.sNum = 0;
    ...
    init = () => {
        ...
        !!this.cTime && this.slider.addEventListener('mouseover', mouseoverStop);
        !!this.cTime && this.slider.addEventListener('mouseleave', mouseleaveStart);
        !!this.cTime && this.slider.addEventListener('focusout', focusOut);
        !!this.cTime && this.slider.addEventListener('focusin', focusinStop);
        !!this.cTime && this.slider.addEventListener('focusout', this.cycle);
